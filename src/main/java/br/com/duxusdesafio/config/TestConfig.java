...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Integrante i2 = new Integrante("dota", "igor", "carry", null); 
		Integrante i3 = new Integrante("lol", "lara", "carry", null);
		Integrante i4 = new Integrante("nw", "maiara", "suporte", null);
		integranteRepository.saveAll(Arrays.asList(i1, i2, i3, i4));
		...
		ComposicaoTime cp2 = new ComposicaoTime(t2, i2);
		ComposicaoTime cp3 = new ComposicaoTime(t3, i3);
		ComposicaoTime cp4 = new ComposicaoTime(t4, i4);
